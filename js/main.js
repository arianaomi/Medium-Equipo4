...
const saveNewPost = () => {
  ...
  let isPopular = $('.form-check-input').is(':checked') ? true : false
  ...
  $('.form-control').each(function (index) {
    ...
    postObject['isPopular'] = isPopular
...
const printGeneralCard = (container, postObject, key) => {
  ...
  $(container).append(`
  <article class="row d-flex no-gutters my-4 generalCards">
      <div class="col-8">
        <div class="pl-1 md-1">
...
const getmostPopular = () => {
  ...
  mostPopular = postWithKeyObjectArr.filter(post => post.isPopular == true)
